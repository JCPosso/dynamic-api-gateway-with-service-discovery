...
const dynamoStack = new dynamodb_stack_1.DynamoDbStack(app, "ServiceRegistryStack");
const routerStack = new lambda_router_stack_1.LambdaRouterStack(app, "LambdaRouterStack", {
